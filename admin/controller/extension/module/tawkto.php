...
class ControllerExtensionModuleTawkto extends Controller {
	...
	public function index() {
		...
		$data['set_widget_url']    = $this->url->link('extension/module/tawkto/setwidget', '', 'SSL') . '&token=' . $this->session->data['token'];
		$data['remove_widget_url'] = $this->url->link('extension/module/tawkto/removewidget', '', 'SSL') . '&token=' . $this->session->data['token'];
	...
	public function setwidget() {
		...
		if(!$this->idsAreCorrect() || !$this->validate()) {
	...
	public function removewidget() {
		...
		$currentSettings = $this->model_setting_setting->getSetting('tawkto');
		unset($currentSettings['tawkto_widget']['widget_settings_for_'.$_POST['id']]);
